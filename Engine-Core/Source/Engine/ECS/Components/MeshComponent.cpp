...
//}
//
//std::vector<VertexPositionNormalUvHeight> MeshComponent::GetPrimitiveTerrainChunkVertices(float width, float height, int densityX, int densityY, const Heightmap* heightmap = nullptr)
//{
